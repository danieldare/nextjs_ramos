  ...
  return (
    <section className="flex flex-col items-center justify-center gap-10 my-20">
      <motion.div
        ...
        className="relative bg-ramos-orange rounded-[35px] shadow-lg shadow-[#fe4a229a] h-[95px] w-[95px] flex justify-center items-center"
      >
        <Image alt="chain" src="/images/chain.png" width={45} height={0} objectFit="cover" />
      </motion.div>
      <h2>
        <StaggeringAnimatedText
          className="text-ramos-black  text-[85px] leading-[70px]"
          text="Get Started"
        />
      </h2>
